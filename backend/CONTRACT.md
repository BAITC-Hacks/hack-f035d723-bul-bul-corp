...
Этот файл и `openapi.json` фиксируют реализованный контракт backend. Аккаунты и профили описаны в [ACCOUNTS.md](ACCOUNTS.md); запуск, состояние интеграции и проверка для жюри находятся в едином [README.md](../README.md).
